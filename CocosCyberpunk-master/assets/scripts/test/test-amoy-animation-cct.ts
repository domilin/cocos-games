import { _decorator, Component, EventKeyboard, EventMouse, Input, input, KeyCode, math, Node, v3, Vec3 } from 'cc';
...
@ccclass('TestAmoyAnimationCCT')
export class TestAmoyAnimationCCT extends Component {
    ...
    updateMove () {
        ...
        //this.actorMove!.getLinearVelocity(this.linearVelocity);
        //this.actorMove!.getAngularVelocity(this.angleVelocity);

        Vec3.copy(this.linearVelocity, this.actorMove.velocity);

        this.linearVelocity.y = 0;
        const linearVelocityLength = this.linearVelocity.length();
        const eulerAnglesY = this.actorMove!.node.eulerAngles.y;
