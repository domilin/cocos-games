import { _decorator, Component, Node, utils, find, Label } from 'cc';
...
@ccclass('grid')
export class grid extends comm {
    ...
    clickGrid() {
        UtilPub.log("------点击grid格子-- x:", this.x, " y:", this.y, UtilScene.getBottomGridPos(this.y, this.x))
    }
